  ...
  <div id="homePage">
    <div class="container">
      ...
      <div class="hero-section">
        <h1 class="hero-title">Sonic AI   一键生成网站</h1>
        <p class="hero-description">零代码·全场景·强智能</p>
      </div>
...
import { addApp, getAppVoListPage, getGoodAppVoListPage } from '@/api/yingyongxiangguanjiekou.ts'
...
const loadMyApps = async () => {
  ...
  try {
    const res = await getAppVoListPage({
...
const loadFeaturedApps = async () => {
  try {
    const res = await getGoodAppVoListPage({
